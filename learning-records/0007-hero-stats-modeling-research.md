...
- **Decomposition**: prefer immutable `Attribute` record, optionally split into `Basic`/`Offensive` VOs; kill flat/bonus and flat/% data clumps. Land incrementally to avoid premature generalization (Clean Code Ch.10).
